...
raceArr = [
    ...
    AdditionalChars:['Load Bearing - Dwarf Characters start the game with the Load Bearing ability. This ability is in addition to any others the character gains from his starting careers.',
    ...
    WeightMale:[42,60],
    WeightFemale:[38,55],
    AdditionalChars:['Deft - Whether or not they have the Skilled archetype, gobber characters start the game with the Deft archetype benefit. This benefit is in addition to any other archetype benefits the character starts with.',
    ...
    WeightMale:[140,195],
    WeightFemale:[95,130],
    AdditionalChars:['Nyss with the Gifted archetype cannot have the Arcane Mechanik, Archanist, Gun Mage, or Warcaster careers.',
    ...
    AdditionalChars:['Trollkin with the gifted archetype cannot have the Arcane Mechanik, Archanist, or Warcaster careers.',
